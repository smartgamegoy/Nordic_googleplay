...
public class EditChangeListener_D implements TextWatcher {

    private String TAG = "EditChangeListener_D";
    private EditText editText;
    private String name;
    private boolean last;

    public EditChangeListener_D(EditText editText, String name) {
