...
public class EditChangeListener_H implements TextWatcher {

    private String TAG = "EditChangeListener_H";
    private EditText editText;
    private String name;
    private boolean last;

    public EditChangeListener_H(EditText editText, String name) {
