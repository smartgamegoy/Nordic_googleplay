...
public class EditChangeListener_E implements TextWatcher {

    private String TAG = "EditChangeListener_E";
    private EditText editText;
    private String name;
    private boolean last;

    public EditChangeListener_E(EditText editText, String name) {
